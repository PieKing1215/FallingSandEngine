...
lazy_static::lazy_static! {
    pub static ref TEST_BIOME_PLACEMENT: BiomePlacement = BiomePlacement {
        points: vec![
            (BiomePlacementParameter { a: 0.0, b: 0.0, c: 0.0 }, Box::new(TestBiomePlacer(placer::SMOOTH_DIRT))),
            ...
            (BiomePlacementParameter { a: 0.5, b: 0.5, c: 0.5 }, Box::new(TestBiomePlacer(placer::SMOOTH_STONE))),
