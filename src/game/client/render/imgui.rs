...
impl Settings {
    ...
    pub fn imgui(&mut self, ui: &imgui::Ui) {
        ...
        ui.window(im_str!("Debug Menu"))
            .size([300.0, 600.0], imgui::Condition::FirstUseEver)
            .flags(WindowFlags::ALWAYS_AUTO_RESIZE)
            .resizable(false)
            .build(|| {
                ui.tree_node_config(im_str!("rendering"))
                    .build(|| {
                        ...
                        if self.draw_chunk_state_overlay {
                            ...
                            Slider::new(im_str!("alpha"), 0.1, 1.0)
                        ...
                        ui.combo_simple_string(im_str!("draw_chunk_collision"),
                ...
                ui.tree_node_config(im_str!("display"))
                    .build(|| {
                        ui.checkbox(im_str!("fullscreen"), &mut self.fullscreen);
                        ui.set_next_item_width(110.0);
                        ui.indent();
                        ui.combo_simple_string(im_str!("fullscreen_type"),
                    ...
                    ui.tree_node_config(im_str!("simulation"))
                    .build(|| {
                        ui.checkbox(im_str!("tick"), &mut self.tick);

                        ui.indent();
                        ui.set_next_item_width(121.0);
                        Slider::new(im_str!("tick_speed"), 1, 120)
                            .flags(SliderFlags::ALWAYS_CLAMP)
                        ...
                        ui.indent();
                        ui.set_next_item_width(121.0);
                        Slider::new(im_str!("tick_lqf_speed"), 1, 120)
                            .flags(SliderFlags::ALWAYS_CLAMP)
                        ...
                        ui.set_next_item_width(121.0);
                        Slider::new(im_str!("tick_lqf_timestep"), 0.01, 1.0)
                            .flags(SliderFlags::ALWAYS_CLAMP)
