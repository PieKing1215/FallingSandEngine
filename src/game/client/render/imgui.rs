            ...
            .build(|| {
                ui.tree_node_config("rendering")
                    .build(|| {
                        ...
                        ui.combo_simple_string("draw_chunk_collision",
                ...
                ui.tree_node_config("display")
                    .build(|| {
                        ...
                        ui.checkbox(
                            "minimize_on_lost_focus",
                            &mut self.minimize_on_lost_focus,
                        );
                    });
                    ui.tree_node_config("simulation")
                    .build(|| {
